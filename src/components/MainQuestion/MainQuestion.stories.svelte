<script>
    ...
    import Question from '../../pages/Question/Question.svelte'
    import MainQuestion from './MainQuestion.svelte'
</script>


<Meta
    title="Example/MainQuestion"
...
<Story 
    ...
    args={{
        question: {
            title: 'P2: Simple Graphics Drawing',
            body: 'Draw a 1:1 recreation of Da Vinci\'s Mona Lisa with Simple Graphics'
        }
    }}
/>
